...
#if defined(MQTT_TASK)
/** MQTT set background thread stack size.
*  @param client - the client object to use
*  @param stack_size - the background thread stack size, 0 for defalult: 4096 Bytes
*  @return success code
*/
DLLExport int MQTTSetTaskStaskSize(MQTTClient* client, unsigned int stack_size);

/** MQTT set background thread priority.
*  @param client - the client object to use
*  @param priority - the background thread priority, 0 for defalult: 100
*  @return success code
*/
DLLExport int MQTTSetTaskPriority(MQTTClient* client, unsigned char priority);
